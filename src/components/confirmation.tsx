...
import { CheckCircle, Plane, Calendar, Armchair, DollarSign, User } from "lucide-react";
  ...
  return (
    <Card className="w-full text-center animate-in fade-in-0 zoom-in-95 duration-500">
        <CardHeader className="items-center">
            ...
            <CardDescription>Your flight for {seat.passengerName} is booked. Have a great trip!</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 text-left">
             <div className="p-4 border rounded-lg bg-card/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2"><User size={16} className="text-primary"/> <span>Passenger: {seat.passengerName}</span></div>

  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {mockFlights.map((flight) => (
        <Card key={flight.id} className="transition-all hover:shadow-lg hover:shadow-primary/20">
          <CardHeader>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p>{new Date(flight.departureTime).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}</p>
              </div>
            </div>
             <div className="flex items-center gap-2">
              <Clock className="text-muted-foreground" size={16} />
              <div>
                ...
                <p>{new Date(flight.arrivalTime).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}</p>
              </div>
            </div>
          </CardContent>
          <CardFooter>
